...
export default function Inicio({ racha, reciente, onIrProgreso }) {
    ...
    <section aria-label="Inicio">
      ...
      <div className="grid-cards" style={{ marginTop: 16 }}>
        ...
        <Tarjeta>
          ...
          <button className="enlace" style={{ alignSelf: 'flex-start' }}>Ver resumen →</button>
        </Tarjeta>
        ...
        <Tarjeta>
          ...
          <button className="enlace" style={{ alignSelf: 'flex-start' }}>Repasar →</button>
        </Tarjeta>
        ...
        <Tarjeta>
          ...
          <button className="enlace" onClick={onIrProgreso} style={{ alignSelf: 'flex-start' }}>Ver requisitos →</button>
        </Tarjeta>
